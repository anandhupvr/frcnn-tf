...
with tf.Session(graph=new_graph) as sess:
	...
	rpn_reg_out = tf.get_default_graph().get_tensor_by_name('f-rcnn/rpn_out_regre/Conv2D:0')
	rpn_cls_out = tf.get_default_graph().get_tensor_by_name('f-rcnn/rpn_out_class/Conv2D:0')

	base_layer = tf.get_default_graph().get_tensor_by_name('f-rcnn/conv5_3/Relu:0')
	out_cls = tf.get_default_graph().get_tensor_by_name('dense_class_2/Reshape_1:0')
	out_box = tf.get_default_graph().get_tensor_by_name('dense_regress_2/Reshape_1/shape:0')
